...
// $app->set('flight.base_url', '/172.16.3.8/prepa_examen',);           // Base URL for your app. Change if app is in a subdirectory (e.g., '/myapp/')
...
// Frais d'achat en pourcentage (ex: 10 = 10%)
$app->set('frais_achat_pourcent', 10);
